	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			allowedTags: ["form", "input", "button", "select", "option", "datalist", "output", "textarea", "fieldset", "legend",
					...
					"code", "span", "div", "label", "a", "br", "p", "del", "strike", "u",
			...
			buttons: ['formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
					...
					'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule','|','html' ], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'

			airButtons: ['formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'fontcolor', 'backcolor'],

			formattingTags: ['p','mark', 'blockquote', 'pre', 'h2', 'h3', 'h4'],
				...
				formatting:
				{
					...
					dropdown:
					{
                        ...
                        mark:
                        {
                            title: 'Mark',
                            exec: 'formatblockx',
                            className: 'redactor_format_mark'
                        },
						blockquote:
						{
							title: RLANG.quote,
